...
export default function ReactQuiz() {
  ...
  return (
    <section className="bg-gradient-to-r from-indigo-500 to-indigo-900 h-screen flex flex-col justify-center items-center">
      <img
        src={ReactLogo}
        alt="React Logo"
      ...
      <button
        popovertarget="quiz"
        className="bg-white text-blue-700 px-5 py-2 rounded-lg mt-5 font-bold hover:bg-blue-700 hover:text-white"
