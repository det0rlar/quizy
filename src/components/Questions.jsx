// * This file contains the Questions component which is used to display the questions and options to the user.
...
export default function Questions({ question, handleAnswerChange, isCorrectAnswer, isSelectedAnswer, handleDoneClick }) {
    ...
    return (
        <>
            <button
                className="bg-blue-500 text-white px-2 float-right rounded-md font-semibold hover:bg-blue-700"
            ...
            <div className="flex justify-end mt-3">
                {index + 1 === questions.length ? (
                    <button
                        className="bg-blue-500 text-white px-3 py-2 rounded-md font-semibold hover:bg-blue-700"
